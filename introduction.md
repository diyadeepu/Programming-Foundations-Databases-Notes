...
- The ability to utilize data automatically, find information more easily, and quickly sort data.

When you store data in a database, what is one advantage you get over a plain spreadsheet?
- Rows of data can be linked with each other from different tables. Some spreadsheets can do this with the help of lookup functions, but building relationships between tables is one of the main functions of relational databases.

What is one advantage of using a spreadsheet to store data?
- When pieces of information are arranged in a consistent way, it becomes easier to see what information you have and find gaps.

The definition of how data in a database will be organized is called the schema.
